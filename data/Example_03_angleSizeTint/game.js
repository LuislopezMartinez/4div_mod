    ...
    switch (ST) {
        ...
        case 10:
            if (glz.mouse.left) {
                ...
                //loader[0] = new LoadImages("data/Example_03_angleSizeTint/images/", 0);
                //loader[1] = new LoadSounds("data/Example_03_angleSizeTint/sounds/", 0);
                // let lista = [];
                // lista.push("data/Example_03_angleSizeTint/models/yourModelFilename.ext);
    ...
    frame() {
        switch (this.st) {
            case 0:
                ...
                break;
            case 10:
                new Cosa2D(100, 100, 1);
                new Cosa2D(300, 100, 2);
                new Cosa2D(500, 100, 3);
                this.st = 20;
                break;
        }
    }
