    ...
    switch (ST) {
        ...
        case 10:
            if (glz.mouse.left) {
                ...
                loader[0] = new LoadImages("data/Example_06_getAngle_getDistance/images/", 1);
                //loader[1] = new LoadSounds("data/Example_06_getAngle_getDistance/sounds/", 0);
                // let lista = [];
                // lista.push("data/Example_06_getAngle_getDistance/models/yourModelFilename.ext);
...
class Game extends GameObject {
    ...
    frame() {
        switch (this.st) {
            case 0:
                new Write(null, 22, "Ejemplo GetDistance, GetAngle y mirrorx/mirrory", CENTER, glz.WIDTH / 2, 30, MAROON, 1);
                this.idText1 = new Write(null, 22, "", CENTER, glz.WIDTH / 2 - 100, 60, BLUE, 1);
                this.idText2 = new Write(null, 22, "", CENTER, glz.WIDTH / 2 + 100, 60, BLUE, 1);
                this.personaje = new Personaje();
                fadeOn(1000);
                this.st = 10;
                break;
            case 10:
                this.idText1.setText("Distance: " + int(getDistance(this.personaje, glz.mouse)));
                this.idText2.setText("Angle: " + int(getAngle(this.personaje, glz.mouse)));
                break;
        }
    }
}
    ...
    frame() {
        switch (this.st) {
            case 0:
                ...
                break;
            case 10:
                if (glz.mouse.x < this.x) {
                    this.mirrorx = true;
                } else if (glz.mouse.x > this.x) {
                    this.mirrorx = false;
                }
                break;
        }
