    ...
    switch (ST) {
        ...
        case 10:
            if (glz.mouse.left) {
                ...
                //loader[0] = new LoadImages("data/Example_09_3d_physics_basic/images/", 0);
                //loader[1] = new LoadSounds("data/Example_09_3d_physics_basic/sounds/", 0);
                // let lista = [];
                // lista.push("data/Example_09_3d_physics_basic/models/yourModelFilename.ext);
...
class Game extends GameObject {
    ...
    frame() {
        switch (this.st) {
            case 0:
                new Write(null, 32, "3D scene physics - basic", CENTER, glz.WIDTH / 2, 30, WHITE, 1);
                setGravity(0, -100, 0);
                this.z = 100;
                this.y = -30;
                this.anglex = 90;
...
class Cosa3d extends GameObject {
    ...
    initialize() {
        ...
        this.createMaterial(PHONG, WHITE);
