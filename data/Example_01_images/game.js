    ...
    switch (ST) {
        ...
        case 10:
            if (glz.mouse.left) {
                ...
                loader[0] = new LoadImages("data/Example_01_images/images/personajes/", 99);
                //loader[1] = new LoadSounds("data/Example_01_images/sounds/", 0);
                // let lista = [];
                // lista.push("data/Example_01_images/models/yourModelFilename.ext);
