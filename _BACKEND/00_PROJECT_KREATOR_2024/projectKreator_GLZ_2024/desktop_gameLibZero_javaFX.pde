...
class scene extends sprite {
    ...
    float scale;
    //++++++++++++++++++++++++++++++++
    public scene( PImage texture, float x, float y, float w, float h , float zoomFactor) {
        this.scale = zoomFactor;
        texture.resize(texture.width*(int)(zoomFactor/100.0), texture.height*(int)(zoomFactor/100.0));
