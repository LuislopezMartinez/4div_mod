    ...
    switch (ST) {
        ...
        case 10:
            if (glz.mouse.left) {
                ...
                //loader[0] = new LoadImages("data/APP_GAME_KONECT_A_PATH/images/", 0);
                //loader[1] = new LoadSounds("data/APP_GAME_KONECT_A_PATH/sounds/", 0);
                //let lista = [];
                //lista.push("data/APP_GAME_KONECT_A_PATH/models/yourModelFilename.ext");
