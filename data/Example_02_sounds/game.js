    ...
    switch (ST) {
        ...
        case 10:
            if (glz.mouse.left) {
                ...
                //loader[0] = new LoadImages("data/Example_02_sounds/images/", 0);
                loader[0] = new LoadSounds("data/Example_02_sounds/sounds/", 1);
                // let lista = [];
                // lista.push("data/Example_02_sounds/models/yourModelFilename.ext);
    ...
    frame() {
        switch (this.st) {
            case 0:
                ...
                new Write(null, 26, "TOUCH SCREEN TO PLAY ANOTHER SOUND!", CENTER, glz.WIDTH / 2, 50, MAROON, 1);
                fadeOn(1000);
                this.st = 10;
                break;
            case 10:
                if (glz.mouse.left) {
                    if (!soundIsPlaying(snd[1])) {
                        soundPlay(snd[1]);
                    }
                }
