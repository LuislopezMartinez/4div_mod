...
const dataPath = "data/Example_15_pixel/";
...
window.setup = function () {
    ...
    setMode(320, 200, false, false);    // define la resolucion grafica..
    ...
    switch (ST) {
        ...
        case 10:
            if (glz.mouse.left) {
                ...
                loader[0] = new LoadImages("data/Example_15_pixel/images/", 0);
                //loader[1] = new LoadSounds("data/Example_15_pixel/sounds/", 0);
                // let lista = [];
                // lista.push("data/Example_15_pixel/models/yourModelFilename.ext);
...
class Game extends Process {
    constructor() {
        super();
        this.st = 0;
        this.text = new Write(null, 64, "HELLO WORLD!", CENTER, WIDTH / 2, HEIGHT / 2 - 50, BLUE, 1);
