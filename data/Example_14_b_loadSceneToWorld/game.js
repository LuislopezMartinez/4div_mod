...
//import { DirectionalLight } from '../../library/three.module.min.js';
/* eslint-disable */
...
const dataPath = "data/Example_14_b_loadSceneToWorld/";
let idCam;
...
window.main = function () {
    switch (ST) {
        case 0:
            WIDTH = glz.WIDTH;
            HEIGHT = glz.HEIGHT;
            text_inicio = new glz.Write(null, 32, "TOUCH TO START", CENTER, WIDTH / 2, HEIGHT / 2, BLUE, 1);
            ST = 10;
            break;
        case 10:
            if (glz.mouse.left) {
                ...
                //loader[0] = new LoadImages("data/Example_14_b_loadSceneToWorld/images/", 0);
                //loader[1] = new LoadSounds("data/Example_14_b_loadSceneToWorld/sounds/", 0);
                // let lista = [];
                // lista.push("data/Example_14_b_loadSceneToWorld/models/yourModelFilename.ext);
        ...
        case 40:
            ...
            //console.log(glz.screenToWorld(glz.mouse.x, glz.mouse.y));
            break;
    }
}
//---------------------------------------------------------------------------------
class Game extends Process {
    ...
    initialize() {
        this.loader = glz.LoadTxt(dataPath + "escena.txt", "\n");
    }
    frame() {
        ...
        switch (this.st) {
            case 0:
                if (this.loader.ready) {
                    let lines = this.loader.get();
                    this.buildScene(lines);
                    fadeOn(2000);
                    this.st = 10;
                }
                break;
