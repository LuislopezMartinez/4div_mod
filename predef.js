...
const dataPath = "data/myGameFolder/";
    ...
    switch (ST) {
        ...
        case 10:
            if (glz.mouse.left) {
                ...
                //loader[0] = new LoadImages("data/myGameFolder/images/", 0);
                //loader[1] = new LoadSounds("data/myGameFolder/sounds/", 0);
                //let lista = [];
                //lista.push("data/myGameFolder/models/yourModelFilename.ext");
