...
import { Camera } from '../../library/three.module.min.js';
    ...
    switch (ST) {
        ...
        case 10:
            if (glz.mouse.left) {
                ...
                //loader[0] = new LoadImages("data/Example_13_FBX_animated_model/images/", 0);
                //loader[1] = new LoadSounds("data/Example_13_FBX_animated_model/sounds/", 0);

                let lista = [];
                lista.push("data/Example_13_FBX_animated_model/models/perso_01/idle.fbx");
                lista.push("data/Example_13_FBX_animated_model/models/perso_01/dance.fbx");
                lista.push("data/Example_13_FBX_animated_model/models/perso_01/lampara.fbx");
                lista.push("data/Example_13_FBX_animated_model/models/perso_01/patada.fbx");
                lista.push("data/Example_13_FBX_animated_model/models/perso_01/patada_2.fbx");
                lista.push("data/Example_13_FBX_animated_model/models/perso_01/spell.fbx");
                lista.push("data/Example_13_FBX_animated_model/models/perso_01/walk.fbx");
    ...
    frame() {
        switch (this.st) {
            case 0:
                this.angley = -90 - 45;
                this.size = 4;
                let model = glz.mixamoMerger(mod);
                this.setModel(model);
                idCam.setTarget(this);
                idCam.setTargetHeight(8);
                idCam.setTargetDistance(15);
                this.clipSet(0);
                this.clipPlay();
                this.st = 10;
                break;
            case 10:
                if (key(_1)) this.clipSwitch(0, 500);
                if (key(_2)) this.clipSwitch(1, 500);
                if (key(_3)) this.clipSwitch(2, 500);
                if (key(_4)) this.clipSwitch(3, 500);
                if (key(_5)) this.clipSwitch(4, 500);
                if (key(_6)) this.clipSwitch(5, 500);
                if (key(_7)) this.clipSwitch(6, 500);
                break;
        }
    }
