    ...
    switch (ST) {
        ...
        case 10:
            if (glz.mouse.left) {
                ...
                loader[0] = new LoadImages("data/Example_05_raycast_with_mouse/images/", 0);
                //loader[1] = new LoadSounds("data/Example_05_raycast_with_mouse/sounds/", 0);
                // let lista = [];
                // lista.push("data/Example_05_raycast_with_mouse/models/yourModelFilename.ext);
...
class Cosa3d extends GameObject {
    ...
    initialize() {
        ...
        this.createMaterial(TEXTURED, "data/Example_05_raycast_with_mouse/images/000.png");
