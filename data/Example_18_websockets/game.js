...
const dataPath = "data/Example_18_websockets/";
    ...
    switch (ST) {
        ...
        case 10:
            if (glz.mouse.left) {
                ...
                //loader[0] = new LoadImages("data/Example_18_websockets/images/", 0);
                //loader[1] = new LoadSounds("data/Example_18_websockets/sounds/", 0);
                //let lista = [];
                //lista.push("data/Example_18_websockets/models/yourModelFilename.ext");
...
class Game extends Process {
    ...
    initialize() {
        glz.socketOpen("ws://localhost", 7777);
        fadeOn(1000);
    }
    frame() {
        switch (this.st) {
            case 0:
                if (glz.socketStatus() == glz.SOCKET_CONNECTED) {
