...
const dataPath = "data/Example_20_particulas_1/";
...
window.setup = function () {
    ...
    glz.setCameraPosition(0, 0, -50);   // set position inicial de la camara hacia la escena..
    ...
    switch (ST) {
        ...
        case 10:
            if (glz.mouse.left) {
                ...
                text_inicio.color = BLUE;
                loader[0] = new LoadImages("data/Example_20_particulas_1/images/", 0);
                //loader[1] = new LoadSounds("data/Example_20_particulas_1/sounds/", 0);
                //let lista = [];
                //lista.push("data/Example_20_particulas_1/models/yourModelFilename.ext");
...
//---------------------------------------------------------------------------------
class Particula extends Process {
    constructor() {
        super();
        this.st = 0;
        this.velocity = 2;
    ...
    initialize() {
        ...
        this.x = random(-80, 80);
        this.y = random(-50, 50);
        this.createSprite(img[0]);

        // tintar el grafico del proceso con color aleatorio r g b en tonos pastel con
        // un minimo por componente de 100..
        this.tint(glz.color(100 + glz.randInt(155), 100 + glz.randInt(155), 100 + glz.randInt(155)));
    }
    frame() {
        switch (this.st) {
            case 0:
                this.z += this.velocity;
                if (this.z > glz.getFog().far) {
                    signal(this, s_kill);
                }
