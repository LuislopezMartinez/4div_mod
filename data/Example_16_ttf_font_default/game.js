...
const dataPath = "data/Example_16_ttf_font_default/";
...
window.main = function () {
    switch (ST) {
        ...
        case 10:
            if (glz.mouse.left) {
                text_inicio.setSize(16);
                text_inicio.text = "loading assets..";
                text_inicio.color = WHITE;
                loader[0] = new LoadImages("data/Example_16_ttf_font_default/images/", 0);
                loader[1] = new LoadSounds("data/Example_16_ttf_font_default/sounds/", 0);
                let list = [];
                list.push("data/Example_16_ttf_font_default/fonts/MSX-Screen0.ttf");
                list.push("data/Example_16_ttf_font_default/fonts/MSX-Screen1.ttf");
...
class Game extends Process {
    ...
    initialize() {
        new Write(fnt[0], 32, "LUIS LOPEZ MARTINEZ", CENTER, WIDTH/2, HEIGHT/2, WHITE, 1);
        new Write(fnt[1], 16, "4DIV.JS - GameLibZero", CENTER, WIDTH/2, HEIGHT/2+32, YELLOW, 1);
        soundPlay(snd[0]);
        fadeOn(6000);
    }
    frame() {
