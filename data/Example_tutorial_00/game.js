...
const dataPath = "data/Example_tutorial_00/";
...
window.main = function () {
    switch (ST) {
        case 0:
            WIDTH = glz.WIDTH;
            HEIGHT = glz.HEIGHT;
            text_inicio = new Write(null, 32, "TOUCH TO START", CENTER, WIDTH / 2, HEIGHT / 2, BLUE, 1);
            ST = 10;
            break;
        case 10:
            if (glz.mouse.left) {
                text_inicio.text = "loading assets..";
                text_inicio.color = BLACK;
                //loader[0] = new LoadImages("data/Example_tutorial_00/images/", 0);
                //loader[1] = new LoadSounds("data/Example_tutorial_00/sounds/", 0);
                //let lista = [];
                //lista.push("data/Example_tutorial_00/models/yourModelFilename.ext");
