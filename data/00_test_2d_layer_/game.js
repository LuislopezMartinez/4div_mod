...
import * as PIXI from '../../library/pixi.min.js';
...
const dataPath = "data/00_test_2d_layer_/";
    ...
    switch (ST) {
        ...
        case 10:
            if (glz.mouse.left) {
                ...
                //loader[0] = new LoadImages("data/00_test_2d_layer_/images/", 0);
                //loader[1] = new LoadSounds("data/00_test_2d_layer_/sounds/", 0);
                //let lista = [];
                //lista.push("data/00_test_2d_layer_/models/yourModelFilename.ext");
    ...
    frame() {
        switch (this.st) {
            case 0:
                this.x = WIDTH / 2;
                this.y = HEIGHT / 2;
                this.newGraph(100, 100);
                this.sizex = 10;
                this.st = 10;
                break;
            case 10:
                this.angle += 0.5;
                //console.log(glz.mouse.gameObject_collision);
                break;
        }
    }
}
