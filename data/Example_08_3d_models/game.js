    ...
    switch (ST) {
        ...
        case 10:
            if (glz.mouse.left) {
                ...
                //loader[0] = new LoadImages("data/Example_08_3d_models/images/", 0);
                //loader[1] = new LoadSounds("data/Example_08_3d_models/sounds/", 0);
                let lista = [];
                lista.push("data/modelos_3d/bolaAmarilla/bolaAmarilla.obj");
                lista.push("data/modelos_3d/bolaPinchos/bolaPinchos.obj");
                lista.push("data/modelos_3d/bomba/agresiva/bomba.obj");
                lista.push("data/modelos_3d/corazon/corazon.obj");
                lista.push("data/modelos_3d/enemigo_00/enemigo_00.obj");
                lista.push("data/modelos_3d/moneda/moneda.obj");
                lista.push("data/modelos_3d/ojo/ojo.obj");
...
//---------------------------------------------------------------------------------
class Cosa3d extends GameObject {
    constructor(x, y, z) {
        super();
        this.idText;
        this.x = x;
    ...
    initialize() {
        ...
        this.idText = new Write(null, 32, "no colision..", CENTER, vec.x, 30, BLUE, 1);
        this.anglex = 90;
    }
    frame() {
        this.angle++;
        ...
        if (colision) {
            this.idText.setText("COLISION!");
        } else {
            this.idText.setText("no colision..");
        }
    }
}
//---------------------------------------------------------------------------------