    ...
    switch (ST) {
        ...
        case 10:
            if (glz.mouse.left) {
                ...
                //loader[0] = new LoadImages("data/Example_07_touch_Joystick/images/", 0);
                //loader[1] = new LoadSounds("data/Example_07_touch_Joystick/sounds/", 0);
                // let lista = [];
                // lista.push("data/Example_07_touch_Joystick/models/yourModelFilename.ext);
    ...
    frame() {
        switch (this.st) {
            case 0:
                ...
                this.idText3 = new Write(null, 16, "", RIGHT, 220, 60, WHITE, 1);
                fadeOn(1000);
                this.st = 10;
                break;
            case 10:
