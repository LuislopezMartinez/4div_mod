...
const dataPath = "data/Example_19_camera3d/";
    ...
    switch (ST) {
        ...
        case 10:
            if (glz.mouse.left) {
                ...
                //loader[0] = new LoadImages("data/Example_19_camera3d/images/", 0);
                //loader[1] = new LoadSounds("data/Example_19_camera3d/sounds/", 0);
                //let lista = [];
                //lista.push("data/Example_19_camera3d/models/yourModelFilename.ext");
...
class Game extends Process {
    constructor() {
        super();
        this.st = 0;
        this.idCam = undefined;
    }
    initialize() {
        new Plano();
        this.idCam = new glz.Cam();
        //this.idCam.setTargetHeight(10);
        this.idCam.setTargetDistance(100);
        this.idCam.setCollision(true);
        this.y = 5;
        this.createSphere(2);
        this.idCam.setTarget(this);
        fadeOn(1000);
    }
    frame() {
        switch (this.st) {
